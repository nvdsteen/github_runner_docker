...
RUN apt-get install -y --no-install-recommends \
    curl nodejs wget unzip vim git jq build-essential libssl-dev libffi-dev python3 python3-venv python3-dev python3-pip libpq-dev
...
# install docker
# https://github.com/HomeLabHQ/runner/tree/main
# ...
